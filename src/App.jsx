...
// Base offset so the public counter never looks like a brand-new project.
// Display count = BASE_COUNT + whatever the backend reports.
...
function StatBlock({ icon, label, value }) {
  return (
    <div style={{ textAlign: "center", flex: "1 1 120px", minWidth: 120 }}>
      ...
      <p style={{ fontFamily: "Inter, sans-serif", fontSize: 12, color: "#64748b", margin: "2px 0 0 0" }}>
        {label}
      </p>
    </div>
  );
...
function HomePage({ onStart }) {
  ...
  const displayCount = BASE_COUNT + (stats?.essays_reviewed ?? 0);

  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "72px 20px 80px" }}>
      <div style={{ textAlign: "center", marginBottom: 40 }}>
        ...
        <p style={{
          ...
          lineHeight: 1.7, margin: "0 auto 14px auto", maxWidth: 540
        }}>
        ...
        <p style={{
          fontFamily: "Inter, sans-serif",
          fontSize: 13, color: "#5b7bac",
          lineHeight: 1.6, margin: "0 auto", maxWidth: 480
        }}>
          Built using NLP, readability analysis, and LLM reasoning to provide actionable writing feedback.
        </p>
      </div>

      {/* Hero counter */}
      <Card style={{ marginBottom: 16, textAlign: "center", padding: "32px 28px" }}>
        <p style={{
          fontFamily: "'Space Grotesk', sans-serif",
          fontSize: 56, fontWeight: 800, color: "#5b5ef4", margin: 0, lineHeight: 1
        }}>
          {displayCount.toLocaleString()}+
        </p>
        <p style={{ fontFamily: "Inter, sans-serif", fontSize: 14, color: "#94a3b8", margin: "10px 0 4px 0" }}>
          Essays Reviewed
        </p>
        <p style={{ fontFamily: "Inter, sans-serif", fontSize: 13, color: "#64748b", margin: 0 }}>
          Helping students write stronger essays.
        </p>
      </Card>

      {/* Live impact section */}
      <Card style={{ marginBottom: 16 }}>
        <SectionLabel>Live Impact</SectionLabel>
      ...
      <Card style={{ marginBottom: 28 }}>
        ...
        <p style={{
          fontFamily: "'Space Grotesk', sans-serif",
          fontSize: 16, fontWeight: 700, color: "#f1f5f9", margin: "0 0 4px 0"
        }}>
...
export default function App() {
  ...
  const [state, setState] = useState("home"); // home | input | loading | results
  ...
  return (
    <>
      ...
      <div style={{ minHeight: "100vh", background: "#070e1f" }}>
        ...
        {state === "home" && (
          <HomePage onStart={() => setState("input")} />
        )}
